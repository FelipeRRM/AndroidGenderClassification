                            ...
                            .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                   // MyEditionsAdapter.this.editions.remove(position);
                                    ...
                                    if(atual.getFiles().size()>0) {
                                        Singleton.getSingleton().setNeedsToTrainNetwork(true);
                                        ((ManageActivity) (context)).getNetworkStatusTxt().setText(context.getString(R.string.needs_training));
                                    }
                                    Geral.deleteDir(new File(Geral.getCategoryFolderPath(atual.getName())));
                                }
                            }).show();
                }
            });
